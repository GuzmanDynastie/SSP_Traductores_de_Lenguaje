...
public class PTF {
    ...
    public static void main(String[] args) {
        ...
        String suma = PTF.sumarNumeros(numero1, numero2);
        System.out.println("El resultado de la suma es: " + suma);

        String resta = PTF.restarNumeros(numero1, numero2);
        System.out.println("El resultado de la resta es: " + resta);

        String multiplicacion = PTF.multiplicarNumeros(numero1, numero2);
